...
INSERT INTO precious_stone (name, min_value, min_coin, max_value, max_coin, material_category, type_id) VALUES
...
INSERT INTO building_material (name, min_value, min_coin, max_value, max_coin, material_category, type_id) VALUES
    ('fa', 0.1, 'COPPER', 1, 'SILVER', 'I', 3),
    ('üveg / kristály', 5, 'GOLD', 50, 'GOLD', 'IV', 3);

INSERT INTO scientific_material (name, min_value, min_coin, max_value, max_coin, material_category, type_id) VALUES
